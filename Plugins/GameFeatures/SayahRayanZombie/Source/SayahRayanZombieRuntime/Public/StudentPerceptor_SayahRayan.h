...
#include "StudentPerceptor_SayahRayan.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class SAYAHRAYANZOMBIERUNTIME_API UStudentPerceptor_SayahRayan : public UActorComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UStudentPerceptor_SayahRayan();
